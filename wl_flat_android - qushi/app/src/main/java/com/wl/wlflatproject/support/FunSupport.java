...
import com.wl.wlflatproject.support.config.AlarmInfo;
import com.wl.wlflatproject.support.config.BaseConfig;
import com.wl.wlflatproject.support.config.DevCmdGeneral;
import com.wl.wlflatproject.support.config.DevCmdOPFileQueryJP;
import com.wl.wlflatproject.support.config.DevCmdOPRemoveFileJP;
import com.wl.wlflatproject.support.config.DevCmdOPSCalendar;
import com.wl.wlflatproject.support.config.DevCmdSearchFileNumJP;
import com.wl.wlflatproject.support.config.DeviceGetJson;
import com.wl.wlflatproject.support.config.OPCompressPic;
import com.wl.wlflatproject.support.config.SameDayPicInfo;
import com.wl.wlflatproject.support.config.SystemInfo;
import com.wl.wlflatproject.support.models.FunDevRecordFile;
import com.wl.wlflatproject.support.models.FunDevStatus;
import com.wl.wlflatproject.support.models.FunDevType;
import com.wl.wlflatproject.support.models.FunDevice;
import com.wl.wlflatproject.support.models.FunDeviceBuilder;
import com.wl.wlflatproject.support.models.FunLoginType;
import com.wl.wlflatproject.support.sdk.bean.DownloadInfo;
import com.wl.wlflatproject.support.sdk.bean.StringUtils;
import com.wl.wlflatproject.support.sdk.struct.H264_DVR_FILE_DATA;
import com.wl.wlflatproject.support.sdk.struct.H264_DVR_FINDINFO;
import com.wl.wlflatproject.support.sdk.struct.ManualSnapModeJP;
import com.wl.wlflatproject.support.sdk.struct.OPRemoveFileJP;
import com.wl.wlflatproject.support.sdk.struct.SDBDeviceInfo;
import com.wl.wlflatproject.support.sdk.struct.SDK_Authority;
import com.wl.wlflatproject.support.sdk.struct.SDK_CONFIG_NET_COMMON_V2;
import com.wl.wlflatproject.support.sdk.struct.SDK_ChannelNameConfigAll;
import com.wl.wlflatproject.support.sdk.struct.SDK_SearchByTime;
import com.wl.wlflatproject.support.sdk.struct.SDK_TitleDot;
import com.wl.wlflatproject.support.sdk.struct.SInitParam;
import com.wl.wlflatproject.support.utils.DeviceWifiManager;
import com.wl.wlflatproject.support.utils.MyUtils;
import com.wl.wlflatproject.support.utils.SharedParamMng;
...
public class FunSupport implements IFunSDKResult {
    ...
    private List<OnFunListener> mListeners = new CopyOnWriteArrayList<OnFunListener>();
...
//			}
    ...
    public boolean requestDeviceLogout(FunDevice funDevice) {
        ...
        if (devSn == null) devSn = "";
        int result = FunSDK.DevLogout(getHandler(), devSn, funDevice.getId());
        // 设置设备未登录状态
        setDeviceHasLogin(devSn, false);
        // 清空临时设备变量
        mCurrDevice = null;
        return (result == 0);
    }
    ...
    public boolean requestDeviceStatus(FunDevType devType, String devMac) {
        ...
        int result = FunSDK.SysGetDevState(handler,
                funDevice.getDevSn(), id);
        return (result == 0);
    }
